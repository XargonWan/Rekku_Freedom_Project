Rekku Freedom Project, or RFP for short (soon to became SyntH as in Synthetic Heart) is FOSS infrastructure to abstract the digital persona entity, know as "synth" from any LLM and Interface.
